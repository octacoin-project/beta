...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Octacoin Core octacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  octacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded octacoin transaction") + "\n" +
              "  octacoin-tx [options] -create [commands]   " + _("Create hex-encoded octacoin transaction") + "\n" +
              "\n";
