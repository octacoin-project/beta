...
const char* BIP71_MIMETYPE_PAYMENT = "application/octacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/octacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/octacoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start octacoin: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Octacoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
